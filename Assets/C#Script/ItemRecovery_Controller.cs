...
public class ItemRecovery_Controller : MonoBehaviour
{
    //落下速度
    ...
    private RectTransform RecoveryTra;
    //Playerを入れる
    ...
    void Start()
    {
        ...
        //Butoonの取得
        Recovery = GameObject.Find("RecoveryButton");
        RecoveryTra = Recovery.GetComponent<RectTransform>();
    }
